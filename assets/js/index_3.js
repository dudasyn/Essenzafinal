    ...
    var t = {
            1296: (t, e, i) => {
                ...
                t.exports = function(t, e, i) {
                    ...
                    function v(e) {
                        var i = n,
                            o = s;
                        return n = s = void 0, l = e, r = t.apply(o, i)
                    }

                    function b(t) {
                        var i = t - c;
                        return void 0 === c || i >= e || i < 0 || d && t - l >= o
                    }
                    ...
                    function w() {
                        ...
                        a = setTimeout(w, function(t) {
                            var i = e - (t - c);
                            return d ? p(i, o - (t - l)) : i
                        }(t))
                    }

                    function _(t) {
                        return a = void 0, y && n ? v(t) : (n = s = void 0, r)
                    }
                    ...
                    function S() {
                        ...
                        if (n = arguments, s = this, c = t, i) {
                            if (void 0 === a) return function(t) {
                                return l = t, a = setTimeout(w, e), h ? v(t) : r
                            }(c);
                            if (d) return a = setTimeout(w, e), v(c)
                        }
                        return void 0 === a && (a = setTimeout(w, e)), r
                    }
                    return e = g(e) || 0, m(i) && (h = !!i.leading, o = (d = "maxWait" in i) ? u(g(i.maxWait) || 0, e) : o, y = "trailing" in i ? !!i.trailing : y), S.cancel = function() {
                        void 0 !== a && clearTimeout(a), l = 0, n = c = s = a = void 0
                    }, S.flush = function() {
                        return void 0 === a ? r : _(f())
                    }, S
                }
            },
            8264: function(t, e, i) {
                            ...
                            var e = t.URL,
                                i = function(e, i) {
                                    ...
                                    ["append", "delete", "set"].forEach((function(t) {
                                        var e = a[t];
                                        a[t] = function() {
                                            e.apply(a, arguments), c && (l = !1, h.search = a.toString(), l = !0)
                                        }
                                    ...
                                    Object.defineProperty(this, "_updateSearchParams", {
                                        ...
                                        writable: !1,
                                        value: function() {
                                            this.search !== d && (d = this.search, l && (c = !1, this.searchParams._fromString(this.search), c = !0))
                                        }
                                    })
                                },
                                n = i.prototype;
            ...
            183: () => {
                const t = e => {
                        ...
                        i.removeEventListener("animationend", t), setTimeout((() => {
                            i.classList.add("kubio-aos-hide-animation")
                        }), 50)
                    },
                    e = e => {
                        const i = new window.IntersectionObserver((e => {
                            e.forEach((e => {
                                const {
                                    target: n,
                                    isIntersecting: s
                                } = e, o = n.getAttribute("data-kubio-aos") || "none";
                                if (!s || "none" === o || n.getAttribute("data-kubio-aos-executed")) return;
                                if (n.closest(".editor-styles-wrapper")) return void i.disconnect();
                                n.setAttribute("data-kubio-aos-executed", !0), n.addEventListener("animationend", t), n.classList.add("force-hide");
                ...
                var i;
                i = () => [...document.querySelectorAll("[data-kubio-aos]")].forEach(e), "loading" !== document.readyState ? i() : document.addEventListener ? document.addEventListener("DOMContentLoaded", i) : document.attachEvent("onreadystatechange", (function() {
            ...
            1164: () => {
                ! function(t, e, i) {
                    ...
                    n = function(i, n) {
                        let s, o, r, a, c, l, h;
                        return l = 0, h = 0, r = 0, a = {}, c = [], o = 0, s = function(t, e) {
                            ...
                            update() {
                                for (h = e.innerHeight, r = 0; r < c.length;) c[r].style.backgroundPosition = "center center", c[r].url = e.getComputedStyle(c[r], !1).backgroundImage.replace(/url\((['"])?(.*?)\1\)/gi, "$2").split(",")[0], c[r].img || (c[r].img = new Image), c[r].url !== c[r].img.src && (this._check(r), c[r].img.src = c[r].url), r++;
                                this._animate()
                            },
                            destroy() {
                            ...
                            _initImage(t, i) {
                                return "" === t.bgSize || "auto" === t.bgSize ? this.height < t.offsetHeight ? t.ok = !1 : (i = this.height, this.height < h && (i += (h - t.offsetHeight) * a.speed)) : "cover" === t.bgSize ? h < t.offsetHeight && (t.ok = !1) : (e.getComputedStyle(t, !1).backgroundSize, this._check(r)), t.diff = -(i - t.offsetHeight) * a.speed, t.diff = t.diff - t.offsetHeight * a.boost, {
                                    main: t,
                                    actualHeight: i
                                }
                            },
                            _initImageData(t) {
                                ...
                                n = c[t];
                                const s = this;
                                if (n.ok = !0, n.bgSize = e.getComputedStyle(n, !1).backgroundSize, i = h, c[t].img.complete) {
                            ...
                            _check(t) {
                                let i, n;
                                n = c[t], n.ok = !0, n.bgSize = e.getComputedStyle(n, !1).backgroundSize, i = h, c[t].img.onload = () => {
                                    const t = this._initImage(n, i);
                            ...
                            _visible(t) {
                                ...
                                return l + h > e && l < e + c[t].offsetHeight
                            },
                            _getOffsetTop: t => e.pageYOffset + t.getBoundingClientRect().top,
                            _animate() {
                                let i, n;
                                for (l = void 0 !== e.pageYOffset ? e.pageYOffset : (t.documentElement || t.body.parentNode || t.body).scrollTop, r = 0; r < c.length;) this._check(r), c[r].ok && "fixed" === e.getComputedStyle(c[r], !1).backgroundAttachment && this._visible(r) && c[r].diff ? (i = (l - this._getOffsetTop(c[r]) + h) / (c[r].offsetHeight + h), n = c[r].diff * (i - .5), "cover" !== c[r].bgSize && (n += (h - c[r].img.height) / 2), n = Math.round(100 * n) / 100, n = `${n}px`) : n = "center", c[r].style.backgroundPosition = "center " + n, r++
                            }
                        }, new s(i, n)
                    }, e.paraxify = n
                }(document, window)
            ...
            9068: () => {
                ...
                function n(t) {
                    const e = this;
                    i(this), this.__resizeRAF__ && o(this.__resizeRAF__), this.__resizeRAF__ = s((function() {
                        (function(t) {
                ...
                if (!t) {
                    var s = function() {
                        ...
                        if (void 0 !== t.style.animationName && (r = !0), !1 === r)
                            for (let e = 0; e < l.length; e++)
                                if (void 0 !== t.style[l[e] + "AnimationName"]) {
                                    a = "-" + l[e].toLowerCase() + "-", c = h[e], r = !0;
                                    break
                                }
                    }
                    var d = "resizeanim",
                        u = "@" + a + "keyframes " + d + " { from { opacity: 0; } to { opacity: 0; } } ",
                        p = a + "animation: 1ms " + d + "; "
                }
                window.addResizeListener = function(s, o) {
                    t ? s.attachEvent("onresize", o) : (s.__resizeTriggers__ || ("static" == getComputedStyle(s).position && (s.style.position = "relative"), function() {
                        if (!e) {
                            const t = (u || "") + ".resize-triggers { " + (p || "") + 'visibility: hidden; opacity: 0; } .resize-triggers, .resize-triggers > div, .contract-trigger:before { content: " "; display: block; position: absolute; top: 0; left: 0; height: 100%; width: 100%; overflow: hidden; } .resize-triggers > div { background: #eee; overflow: auto; } .contract-trigger:before { width: 200%; height: 200%; }',
                                i = document.head || document.getElementsByTagName("head")[0],
                                n = document.createElement("style");
                            n.type = "text/css", n.styleSheet ? n.styleSheet.cssText = t : n.appendChild(document.createTextNode(t)), i.appendChild(n), e = !0
                        }
                    }(), s.__resizeLast__ = {}, s.__resizeListeners__ = [], (s.__resizeTriggers__ = document.createElement("div")).className = "resize-triggers", s.__resizeTriggers__.innerHTML = '<div class="expand-trigger"><div></div></div><div class="contract-trigger"></div>', s.appendChild(s.__resizeTriggers__), i(s), s.addEventListener("scroll", n, {
                        passive: !0
                    }), c && s.__resizeTriggers__.addEventListener(c, (function(t) {
                        t.animationName == d && i(s)
                    }))), s.__resizeListeners__.push(o))
                }, window.removeResizeListener = function(e, i) {
                    if (t) e.detachEvent("onresize", i);
                    else {
                        if (!(e && e.__resizeListeners__ && e.__resizeTriggers__)) return;
                        e.__resizeListeners__.splice(e.__resizeListeners__.indexOf(i), 1), e.__resizeListeners__.length || (e.removeEventListener("scroll", n), e.__resizeTriggers__ = !e.removeChild(e.__resizeTriggers__))
                    }
                }
            },
            9665: () => {
                ! function(t) {
                    ...
                    t.fn.smoothScrollAnchor = function(i) {
                        ...
                        passive: !0
                    }), t(window).on("smoothscroll.update", c), t(window).on("smoothscroll.update", l), t(l))
                }(jQuery)
            },
            6177: () => {
                ! function(t, e) {
            ...
            9633: () => {
                var t;
                t = jQuery, Colibri, t((function() {
                    const e = t(".kubio-language-switcher__flags"),
                        i = e.find("li a");
                    if (0 === e.length) return;
                    const n = t.throttle((t => {
                        e.hasClass("hover") ? t.stopImmediatePropagation() : (t.preventDefault(), t.stopImmediatePropagation(), e.addClass("hover"))
                    }), 500);
                    t(window).on("tap", (() => {
            ...
            2111: () => {
                jQuery((function() {
                    const t = "kubio-recommendation-page-iframe__wrapper--is-visible",
                        e = e => {
                            var i, n;
                            null == e || null === (i = e.classList) || void 0 === i || null === (n = i.remove) || void 0 === n || n.call(i, t)
                        };
                    [...document.querySelectorAll("[data-open-recommendation-page-iframe-in-lightbox]")].forEach((i => {
                        const n = i.getAttribute("data-open-recommendation-page-iframe-in-lightbox");
                        if (!n) return;
                        const s = (t => document.querySelector(`#${t}`))(n);
                        s && ((t => {
                            document.body.append(t)
                        })(s), i.addEventListener("click", (() => (e => {
                            e.classList.add(t)
                        })(s))), (t => {
                            const i = t.querySelector(".kubio-recommendation-page-iframe__close");
                            i && i.addEventListener("click", (() => e(t)))
                        })(s), (t => {
                            const i = t.querySelector("iframe");
                            i && i.addEventListener("load", (() => {
                                var n;
                                const s = null == i || null === (n = i.contentDocument) || void 0 === n ? void 0 : n.body;
                                s && s.addEventListener("click", (i => {
                                    i.target.closest(".kubio-recommendation-content-column") || e(t)
                                }))
                            }))
                        })(s))
                    }))
    ...
    (() => {
        ...
        const t = function() {
            ...
            return Function.prototype.inherits = function(t) {
                    ...
                    var t, e, i, n;
                    return !(null === (t = top) || void 0 === t || null === (e = t.wp) || void 0 === e || !e.blockEditor) && (null === (i = top) || void 0 === i || null === (n = i.kubio) || void 0 === n ? void 0 : n.blockLibrary)
                }, e.prototype = {
                    updateOpts(e) {
                    ...
                    create(e, i) {
                        return i = void 0 === i ? e.toLowerCase() : i, i = n + i, t.fn[i] = function(n, s) {
                            ...
                            return this.each((function() {
                                const i = t(this);
                                let l = i.data(a);
                                if (s = "object" == typeof n ? n : s, l || (i.data(a, {}), l = new o[e](this, s), i.data(a, l)), "string" == typeof n)
                                    if (t.isFunction(l[n])) {
                                        const t = l[n].apply(l, r);
                                        void 0 !== t && c.push(t)
                    ...
                    startAutoloadOnceDebounced: function(t, e = 300) {
                        let i;
                        return (...n) => {
        ...
        }), s.debounce || (s.debounce = r()), s.event.special.tap || (s.event.special.tap = {
            setup(t, e) {
        ...
        const c = /^.*(?:(?:youtu\.be\/|v\/|vi\/|u\/\w\/|embed\/)|(?:(?:watch)?\?v(?:i)?=|&v(?:i)?=))([^#&?]*).*/,
            l = {
                native: class extends a {
                    constructor(t, e) {
                ...
                youtube: class extends a {
                    ...
                    getVideoID() {
                        const t = this.settings.videoUrl.match(c);
        ...
        class h {
            ...
            constructor(t, i) {
                return this.$ = jQuery, this.namespace = this.constructor.componentName(), this.utils = new e.Utils, this.detect = new e.Detect, this.init(), e.apply(this, arguments), this.start(), this.isCustomizerPreview() && this.wpCustomize(wp.customize), this
            }
            init() {}
            isCustomizerPreview() {
                return e.isCustomizerPreview()
            }
            wpCustomize(t) {}
            wpSettingBind(t, e) {
        ...
        e.registerPlugin = function(t, i, n) {
                "function" == typeof t.componentName && (n = i, t = (i = t).componentName()), e[t] = i, e.Plugin.create(t), !1 !== n && e.Plugin.autoload(t)
            }, e.registerPlugin(class extends h {
                static componentName() {
                ...
                init() {
                    this.currentIndex = 0, this.interval = -1, this.debouncedRestart = r()((() => {
                        this.stop(), this.start()
                    }), 500)
                }
                addImageEffect(t, e) {
            ...
            }(jQuery, Colibri), i(6177), i(183), i(9633), i(9665), i(9543), i(2111)
    })(), (window.kubio = window.kubio || {}).scripts = n
})();